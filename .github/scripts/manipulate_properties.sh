...
if [[ "$RUNNER_OS" == "macOS" ]]; then
  ...
  sed -i "" "s|executableName = dotnet SampleConsumer.dll|executableName = dotnet bin/Bootstrap.dll --properties kcl.properties --execute|g" SampleConsumer/kcl.properties
